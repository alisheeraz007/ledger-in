  ...
  return (
    <>
      <div className="row">
        ...
        <div className="col-lg-6 col-xxl-4" style={{ height: "517px" }}>
          <ListsWidget9 className="card-stretch gutter-b" />
        </div>
        <div className="col-lg-6 col-xxl-4" style={{ height: "517px" }}>
          <ListsWidgetCashFlow className="card-stretch gutter-b" />
        </div>
        <div className="col-lg-6 col-xxl-4 order-1 order-xxl-1" style={{ height: "517px" }}>
