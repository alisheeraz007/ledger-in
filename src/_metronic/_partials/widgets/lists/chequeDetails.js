                ...
                <>
                    ...
                    >
                        <DialogContentText id="alert-dialog-slide-description">
                            ...
                            >
                                <div className="mt-3" style={{ display: "flex", alignItems: 'center' }}>
                                    ...
                                    <div>
                                        <h5>Bank</h5>
                                        <p>{props.value.DepositBank}</p>
                                    </div>
                                </div>
                                <div className="mt-3" style={{ display: "flex", alignItems: 'center' }}>
                                    <div style={{ width: '50%' }}>
                                        <h5>Discription</h5>
                                        <p>{props.value.ReturnDes}</p>
                                    </div>
                                ...
                                <div>
                                    <div style={{ display: "flex", alignItems: "center" }}>
                                        <h5 style={{ margin: '0px' }}>Have You Returned This Cheque Back?</h5>
                                        <Button>Return</Button>
                                    </div>
                                    <div style={{ display: "flex", alignItems: "center" }}>
                                        <h5 style={{ margin: '0px' }}>Have You Deposit This Cheque In Another Bank?</h5>
                                        <Button onClick={() => setShowDetail(true)}>Add Details</Button>
                                    </div>
                                </div>
                            </div>
                        </DialogContentText>
                        ...
                        {showDetail ?
                            ...
                            <DialogContentText style={{ transition: "0.3s" }} id="alert-dialog-slide-description">
                                <div
                                    style={{ width: "552px" }}
                                >
                                    <Formik
                                            ...
                                            <>
                                                <Form className="form form-label-right">
                                                    <div style={{
                                                        ...
                                                        <div style={{
                                                            padding: "0px"
                                                        }} className="col-lg-4" style={{ borderRight: "1px solid black", padding: "0px" }}>
                                                    ...
                                                    {ChequeType === 'Gross Cheque' ?
                                                        ...
                                                        <button
                                                            ...
                                                            onClick={(ev) => {
                                                                handleClose();
                                                                ev.preventDefault()
                                                                props.saveStatus({ ...props.value, bankStatus: 'Cleared', payment_Type: 'Cash', payment_mode: 'Cash' }, 'Cash')
                                                            }}
                                                        // color="primary"
                                                        >
                                                            WITHDRAW
